...
def animate_plasma_shape(speed=1.0, num_steps=100):
    ...
    ax1.set_title(
        "Plasma Shape Trajectory - Live Movement", fontsize=14, fontweight="bold"
    )
    ...
    (current_point3d,) = ax2.plot(
        [], [], [], "o", markersize=20, markeredgewidth=2, zorder=5
    )
    ...
    anim = FuncAnimation(
        fig, animate, frames=len(trajectory), interval=interval, blit=True, repeat=True
    )
