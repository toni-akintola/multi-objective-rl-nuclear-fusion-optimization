      ...
      <div className="mx-auto w-full max-w-5xl">
        ...
        <div className="mb-12 space-y-8 md:space-y-10">
          ...
          >
            ...
            <div className="max-w-2xl space-y-3 leading-relaxed text-foreground/70 md:text-lg">
              <p>
        ...
        <div className="border-t border-foreground/10 py-12">
          <div
            className={`transition-all duration-700 ${
              isVisible ? "translate-y-0 opacity-100" : "translate-y-12 opacity-0"
            }`}
        ...
        <div className="border-t border-foreground/10 pt-12">
          ...
          >
            ...
            <p className="mb-4 max-w-2xl leading-relaxed text-foreground/70 md:text-lg">
